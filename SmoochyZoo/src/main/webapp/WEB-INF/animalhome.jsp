...
<body>
	...
	<form action="getAnimalById.do" method="GET">
		Animal ID: <input type="number" name="animalId" /> <input
			type="submit" value="Show Animal" />
	</form>
	<br>
	<br>
	...
	<form action="getAllAnimalsByName.do" method="GET">
		Animal Name: <input type="text" name="name" /> <input type="submit"
			value="Show Animals with the name provided" />
	</form>
	<br>
	<br>
	...
	<form action="getAllAnimalsBySpecies.do" method="GET">
		...
		</select> <input type="submit" value="Show Animals with the species provided" />
	</form>
	<br>
	<br>
	...
	<form action="getAllAnimalsByCategory.do" method="GET">
		...
		</select> <input type="submit" value="Show Animals with the category provided" />
	</form>
	<br>
	<br>
</body>
